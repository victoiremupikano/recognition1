...
namespace recognition
{
    public partial class frmMain : Form
    {
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"C:\haarcascades\haarcascade_frontalface_alt.xml");
        ...
        private void btnRecognizePerson_Click(object sender, EventArgs e)
        {
            TrainImagesFromDir();
        }
